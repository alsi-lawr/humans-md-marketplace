...
`--apply`, review the plan, then ask once before applying. Omit `--multi-agent-version` for the
compatible V1 default, or pass `--multi-agent-version v2` with Codex 0.145.0 or newer. This
