...
final disposition, selects decision scope, routes corrections, escalates non-obvious contention,
enforces phase boundaries, and persists planning state and strategy transitions.
